...
STORY_PROMPT = """
    ...
    "xp_earned" will be an integer, "damage_taken" will be an integer, and "new_items" will be a list of dictionaries 
    of items that the player has gained. 
    
    The dictionaries in new_items will contain the following key value pairs:
